...
Instrument.create(:id => 10, :display_name => "Piccolo",  :large_ensemble => "band_or_orchestra", :instrument_type => "wind")
Instrument.create(:id => 11, :display_name => "Flute",  :large_ensemble => "band_or_orchestra", :instrument_type => "wind")
Instrument.create(:id => 12, :display_name => "Oboe",  :large_ensemble => "band_or_orchestra", :instrument_type => "wind")
Instrument.create(:id => 14, :display_name => "Bassoon",  :large_ensemble => "band_or_orchestra", :instrument_type => "wind")
Instrument.create(:id => 15, :display_name => "Clarinet",  :large_ensemble => "band_or_orchestra", :instrument_type => "wind")
Instrument.create(:id => 37, :display_name => "Clarinet-Alto",  :large_ensemble => "band_or_orchestra", :instrument_type => "wind")
Instrument.create(:id => 16, :display_name => "Clarinet-Bass",  :large_ensemble => "band_or_orchestra", :instrument_type => "wind")
Instrument.create(:id => 17, :display_name => "Saxophone", :large_ensemble => "band", :instrument_type => "wind")
Instrument.create(:id => 18, :display_name => "Saxophone-Soprano", :large_ensemble => "band", :instrument_type => "wind")
Instrument.create(:id => 19, :display_name => "Saxophone-Alto", :large_ensemble => "band", :instrument_type => "wind")
Instrument.create(:id => 20, :display_name => "Saxophone-Tenor", :large_ensemble => "band", :instrument_type => "wind")
Instrument.create(:id => 21, :display_name => "Saxophone-Baritone", :large_ensemble => "band", :instrument_type => "wind")
