...
Instrument.create(:id => 1,  :display_name => "Voice-Soprano",  :large_ensemble => "chorus", :evaluation_class => "VocalEvaluation")
Instrument.create(:id => 2,  :display_name => "Voice-Alto",  :large_ensemble => "chorus", :evaluation_class => "VocalEvaluation")
Instrument.create(:id => 3,  :display_name => "Voice-Tenor",  :large_ensemble => "chorus", :evaluation_class => "VocalEvaluation")
Instrument.create(:id => 4,  :display_name => "Voice-Baritone",  :large_ensemble => "chorus", :evaluation_class => "VocalEvaluation")
Instrument.create(:id => 5,  :display_name => "Voice-Bass",  :large_ensemble => "chorus", :evaluation_class => "VocalEvaluation")
Instrument.create(:id => 6,  :display_name => "Violin", :large_ensemble => "orchestra", :evaluation_class => "StringEvaluation")
Instrument.create(:id => 7,  :display_name => "Viola", :large_ensemble => "orchestra", :evaluation_class => "StringEvaluation")
Instrument.create(:id => 8,  :display_name => "Cello", :large_ensemble => "orchestra", :evaluation_class => "StringEvaluation")
Instrument.create(:id => 9,  :display_name => "Double Bass", :large_ensemble => "orchestra", :evaluation_class => "StringEvaluation")
Instrument.create(:id => 10, :display_name => "Piccolo",  :large_ensemble => "band_or_orchestra", :evaluation_class => "WindEvaluation")
Instrument.create(:id => 11, :display_name => "Flute",  :large_ensemble => "band_or_orchestra", :evaluation_class => "WindEvaluation")
Instrument.create(:id => 12, :display_name => "Oboe",  :large_ensemble => "band_or_orchestra", :evaluation_class => "WindEvaluation")
Instrument.create(:id => 14, :display_name => "Bassoon",  :large_ensemble => "band_or_orchestra", :evaluation_class => "WindEvaluation")
Instrument.create(:id => 15, :display_name => "Clarinet",  :large_ensemble => "band_or_orchestra", :evaluation_class => "WindEvaluation")
Instrument.create(:id => 37, :display_name => "Clarinet-Alto",  :large_ensemble => "band_or_orchestra", :evaluation_class => "WindEvaluation")
Instrument.create(:id => 16, :display_name => "Clarinet-Bass",  :large_ensemble => "band_or_orchestra", :evaluation_class => "WindEvaluation")
Instrument.create(:id => 17, :display_name => "Saxophone", :large_ensemble => "band", :evaluation_class => "WindEvaluation")
Instrument.create(:id => 18, :display_name => "Saxophone-Soprano", :large_ensemble => "band", :evaluation_class => "WindEvaluation")
Instrument.create(:id => 19, :display_name => "Saxophone-Alto", :large_ensemble => "band", :evaluation_class => "WindEvaluation")
Instrument.create(:id => 20, :display_name => "Saxophone-Tenor", :large_ensemble => "band", :evaluation_class => "WindEvaluation")
Instrument.create(:id => 21, :display_name => "Saxophone-Baritone", :large_ensemble => "band", :evaluation_class => "WindEvaluation")
Instrument.create(:id => 22, :display_name => "Trumpet",  :large_ensemble => "band_or_orchestra", :evaluation_class => "BrassEvaluation")
Instrument.create(:id => 23, :display_name => "Horn",  :large_ensemble => "band_or_orchestra", :evaluation_class => "BrassEvaluation")
Instrument.create(:id => 24, :display_name => "Trombone",  :large_ensemble => "band_or_orchestra", :evaluation_class => "BrassEvaluation")
Instrument.create(:id => 25, :display_name => "Trombone-Bass",  :large_ensemble => "band_or_orchestra", :evaluation_class => "BrassEvaluation")
Instrument.create(:id => 26, :display_name => "Euphonium",  :large_ensemble => "band", :evaluation_class => "BrassEvaluation")
Instrument.create(:id => 27, :display_name => "Tuba",  :large_ensemble => "band_or_orchestra", :evaluation_class => "BrassEvaluation")
Instrument.create(:id => 28, :display_name => "Percussion",  :large_ensemble => "band_or_orchestra", :evaluation_class => "PercussionEvaluation")
Instrument.create(:id => 31, :display_name => "Timpani",  :large_ensemble => "band_or_orchestra", :evaluation_class => "PercussionEvaluation")
Instrument.create(:id => 32, :display_name => "Harp",  :large_ensemble => "orchestra", :evaluation_class => "PianoEvaluation")
Instrument.create(:id => 34, :display_name => "Piano",  :large_ensemble => "none", :evaluation_class => "PianoEvaluation")
